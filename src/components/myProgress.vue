...
export default {
  ...
  watch: {
    ...
    //   // if (val <= oldVal) {
    //   //   this.$parent.reverse = true;
    //   // } else {
    //   //   this.$parent.reverse = false;
    //   // }
    //   if (val - oldVal < -1) {
    //     this.$parent.reverse = true;
  ...
  methods: {
    nextTime() {
      if (this.$refs.audio) {
        this.currentTime = this.$refs.audio.currentTime + 15;
        this.currentTime =
          this.currentTime < this.$refs.audio.duration
            ? this.currentTime
            : this.$refs.audio.duration;
        this.handleProgressPanend();
      }
    },
    prevTime() {
      if (this.$refs.audio) {
        this.currentTime = this.$refs.audio.currentTime - 15;
        this.currentTime = this.currentTime > 0 ? this.currentTime : 0;
        this.handleProgressPanend();
      }
    },
